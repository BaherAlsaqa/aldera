...
class _MyTextFieldState extends State<CustomTextField> {
        ...
        children: [
          TextFormField(
            ...
            validator: (value) {
              ...
              } else if (value.length < 9 && widget.type == MOBILE && widget.enableValidation) {
                setState(() {
                  this.value = true;
                });
            ...
            decoration: InputDecoration(
              ...
              border: UnderlineInputBorder(
                  borderSide: BorderSide(
                      color: borderGray.withOpacity(0.5), width: 2.h)),
  ...
  Widget prefix() {
    return Padding(
      padding: EdgeInsetsDirectional.only(start: 5.w, bottom: widget.type == MESSAGE? 99.h: 0.h),
                ...
                : widget.type == FULL_NAME
                    ...
                    : widget.type == EMAIL
                        ...
                        : widget.type == CODE || widget.type == PROMO_CODE
                            ? "code.svg"
                            : widget.type == MESSAGE? "message.svg": "lock.svg"),
      ),
    );
  }
}
